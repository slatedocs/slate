...
[Source](http://docs.bons.ai/http-api-reference-pages/api-reference "Permalink to API Reference - Bons.ai")

# API Reference - Bons.ai
...
> _requestMethod_ /v1/_userName_/_assetName_/_assetVersion_
...
* assetName: Name of the asset. This could be a BRAIN (_brainName_)_, _dataset (_datasetNam_e), etc.
...
> **GET /v1/_userName/brainName_**

Uses the GET request method to get information about a BRAIN (_brainName_) created by a user (_userName_).

### Example Response

This is an example response for getting BRAIN information for a specific user.
...
> **GET /v1/_userName_/_brainName_/_brainVersion_/ink**
...
> **POST /v1/_userName_/_brainNam_e/ink**
...
> **GET /_userName_/_brainName_/sims**
...
> **GET /V1/_userName_/_brainName_/sims/ws**
...
> **PUT /v1/_userName_/_brainName_/train**
