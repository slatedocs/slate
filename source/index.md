...
The embed tiles are designed to be fully resizable to fit any space given. They also work responsively, so on mobile devices the display will fit appropriately.

Most URLs are auto-generated by our embed widget located within our client. But the general URL is typically in the form of:

```shell
http://www.vestorly.com/embed?group_id=53719f5d869833000200009f&advisor_id=wiszdom& embed_type=vertical&skip=0&limit=12
```
...
# Query Recommended and Trending Content
...
# Display content library content
