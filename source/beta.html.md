...
| [address_information] state | string | Estado onde aluno reside |
| [address_information] postal_code | string | Código postal onde aluno reside |
| [admission] created_at | string | Data de criação da admissão no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
...
| [exam_location] state | string | Estado da localização do exame vestibular |
| [exam_location] postal_code | string | Código postal da localização do exame vestibular |
| [exam] date | string | Data da realização do exame vestibular no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| [exam] time | string | Hora da realização do exame vestibular no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| [exam] status | string | Status do exame vestibular |
| [exam] created_at | string | Data da criação do exame vestibular no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| result | string | Resultado do exame vestibular |
| created_at | string | Data de criação da inscrição para exame no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
...
| dates | array | Lista das datas dos exames no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| times | array | Lista dos horários de aplicações dos exames no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| status | string | Situação dos exames entre `active` e `inactive` |
| kind | string | Tipo dos exames desse lote |
| created_at | string | Data de criação do lote de exames no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
...
| date | string | Data do exame vestibular no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| time | string | Horário do exame vestibular no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| status | string | Situação do exame entre `active` e `inactive` |
| created_at | string | Data de criação do exame no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
...
| created_at | string | Data de criação do exame de enem no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
...
| Nome | Tipo | Descrição |
| ---- | ---- | --------- |
| created | string | Data que foi criado o evento no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
...
| Nome | Tipo | Descrição |
| ---- | ---- | --------- |
| start_date     | string | Data inicial do filtro no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
| end_date       | string | Data final do filtro no formato [ISO 8601](https://pt.wikipedia.org/wiki/ISO_8601) |
