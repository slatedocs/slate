...
> Example Request (Lookup email recipient):
...
```json
{
  ...
  "email": "name@transferwise.com",
  "currency": "EUR",
  "uniqueId": {
    "type": "email",
    "value": "name@transferwise.com"
  },
  "targetRecipient": {
    "id": 9687003,
...
```
Before you create an **email recipient**, you can do a lookup to see if they have an existing TransferWise recipient account already.
...
Field                             | Description                                                   | Format
---------                         | -------                                                       | -----------
currencyCode                      | The recipient's currency (e.g. EUR)                           | Text
sourceCurrencyCode                | The currency you are sending from (e.g. GBP)                  | Text
type                              | Always "email"                                                | Text
uniqueId                          | The recipeint's email                                         | Text
...
---------                         | -------                                                       | -----------
type                              | Recipient type                                                | Text
receiverType                      | PRIVATE or BUSINESS                                           | Text
Email                             | Recipient email                                               | Text
currency                          | Currency                                                      | Text
uniqueId.type                     | Recipient type (always email)                                 | Text
uniqueId.value                    | Recipient email (same as above)                               | Text
targetRecipient.id                | Recipient ID                                                  | Long
targetRecipient.name              | Name                                                          | Text
targetRecipient.currency          | Currency                                                      | Text
targetRecipient.country           | Three letter country code                                     | Text
targetRecipient.countryISO2Code   | Two letter country code                                       | Text
targetRecipient.email             | Email (same as above)                                         | Text
targetRecipient.type              | Bank account type                                             | Text
targetRecipient.shortAccountString| Obfuscated bank account number                                | Text
targetRecipient.receiverType      | PRIVATE or BUSINESS (same as above)                           | Text
targetRecipient.avatarUrl         | Recipient avatar                                              | Text
targetRecipient.bankName          | Name of the recipient bank                                    | Text
targetRecipient.IBAN (example)    | Obfuscated IBAN (field name depends on targetRecipient.type)  | Text
