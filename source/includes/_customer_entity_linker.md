# Customer Entity Linker
This description is not yet complete it should be filled in!


## The customer_entity_linker object

Field | Description
------:|:------------
__customer_entity_linker_id__ <br><font color="DarkGray">_int_</font> <font color="Crimson">__(primary key)__</font> | A description for this column hasn't been written yet it should be filled in!
...
> and we can retrieve all customer_entity_linker by omitted the customer_entity_linker_id:
...
method | `GET`
url_params | `customer_entity_linker_id` (int)
...
endpoint | `/v1/customer_entity_linker/<customer_entity_linker_id>`
method | `DELETE`
url_params | customer_entity_linker_id <font color="DarkGray">(pk_type)</font>
query params | <font color="DarkGray">N/A</font>
body | <font color="DarkGray">N/A</font>
permissions | <font color="Crimson">__`SYSTEM`__</font>
response | `204`
