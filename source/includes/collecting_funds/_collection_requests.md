...
status | string | This is the status of the collection request. Possible values are: pending, pending_dispatched, processing_started, successful, failed, expired or reversed
