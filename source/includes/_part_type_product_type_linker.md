...
> and we can retrieve all part_type_product_type_linker by omitted the part_type_product_type_linker_id:
...
endpoint | `/v1/part_type_product_type_linker/<part_type_product_type_linker_id>`
method | `DELETE`
url_params | part_type_product_type_linker_id <font color="DarkGray">(pk_type)</font>
query params | <font color="DarkGray">N/A</font>
body | <font color="DarkGray">N/A</font>
permissions | <font color="Crimson">__`SYSTEM`__</font>
response | `204`
