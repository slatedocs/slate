...
| **maxQuantity** **\*** | Integer | - | The maximum transaction count for the period. Use this to define for example monthly (or any other period) request limit to the data product |
|  |  |  |  |
