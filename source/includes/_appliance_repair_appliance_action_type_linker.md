## <u>Appliance Repair Appliance Action Type Linker</u>
...
```python
    url = "http://smartapi.bboxx.co.uk/v1/appliance_repair_appliance_action_type_linker"
    data = json.dumps({
...
```python
    url = 'http://smartapi.bboxx.co.uk/v1/appliance_repair_appliance_action_type_linker/1'
    headers = {'Content-Type': 'application/json', 'Authorization': 'Token token=A_VALID_TOKEN'}
