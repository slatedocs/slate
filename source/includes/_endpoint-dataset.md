...
weight_variables | array | Contains aliases of weight variables to start this dataset with; variables must be numeric type. Weight from settings will be automatically added if not present
