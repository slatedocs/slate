...
0. В случае наличия в ней старой версии iDa Light или iDa Pro (в зависимости от того, что обновляется) - удалить файл pro.war и дождаться пока папка обновляемого приложения удалится автоматически (~ 15 секунд)
