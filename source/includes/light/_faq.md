...
<aside class="warning">Панель администратора передается при приобретении банком только iDa Light. Поддержка консоли администратора прекращена в 2014 году</aside>
