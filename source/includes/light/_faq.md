...
**Установка панели администрирования iDa Light Single Use**
...
<aside class="warning">Панель администратора передается при приобретении банком только iDa Light без условия использования web сервисов. Поддержка консоли администратора прекращена в 2014 году</aside>
