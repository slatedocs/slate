...
POST a Shoji Entity to this catalog to create a new multitable definition. Entities must include a `name` and a
`template`. If omitted, `is_public` defaults to False. A successful POST yields a 201 response
