## <u>Appliance Repair Appliance Symptom Linker</u>
...
```python
    url = "http://smartapi.bboxx.co.uk/v1/appliance_repair_appliance_symptom_linker"
    data = json.dumps({
...
```python
    url = 'http://smartapi.bboxx.co.uk/v1/appliance_repair_appliance_symptom_linker/1'
    headers = {'Content-Type': 'application/json', 'Authorization': 'Token token=A_VALID_TOKEN'}
