...
3. OY! will display the amount you input PLUS three-dgits unique code generated by us.
4. Transfer the exact nominal that appeared on the screen to the bank account stated on the page. Please make sure to use BCA bank account. 
5. After the transaction is successful, the ORIGINAL AMOUNT will be reflected in your balance.
