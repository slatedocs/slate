...
`deletedAuditEvent`</br>*Object* | An object containing details from the deletion audit event associated to the invoice's orgnaization. Only present is the invoice's organization is deleted.
`deletedAuditEvent.id`</br>*UUID* | The ID for the audit event for the deletion of the invoice's organization.
`deletedAuditEvent.created`</br>*date* | The creation date for the deletion audit event for the deletion of the invoice's organization.
`deletedAuditEvent.updated`</br>*date* | The last updated date for the deletion audit event for the deletion of the invoice's organization.
