...
email-addresses | Supply one or more (max 5) email addresses for us to send report alerts to. Emails should be in an array. This only takes effect if notify is set to yes.
