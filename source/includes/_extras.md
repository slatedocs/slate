...
RestClient.get('https://app.rubberstamp.io/api/v1/extras')
```

```shell
curl 'https://app.rubberstamp.io/api/v1/extras'
  -X GET
...
`GET https://app.rubberstamp.io/api/v1/extras`
...
RestClient.get('https://app.rubberstamp.io/api/v1/locales/en')
```

```shell
curl 'https://app.rubberstamp.io/api/v1/locales/en'
  -X GET
  -H "Content-Type: application/json"
```
...
`GET https://app.rubberstamp.io/api/v1/locales/:locale`
...
RestClient.get(
'https://app.rubberstamp.io/api/v1/track',
  {
    tracking_info: {
      event: 'yyy',
...
```shell
curl 'https://app.rubberstamp.io/api/v1/track'
  -X GET
  -H "Content-Type: application/json"
...
`GET https://app.rubberstamp.io/api/v1/track`
...
RestClient.get('https://app.rubberstamp.io/api/v1/useralreadyregistered?email=test@example.com')
```

```shell
curl 'https://app.rubberstamp.io/api/v1/useralreadyregistered?email=test@example.com'
  -X GET
  -H "Content-Type: application/json"
```
...
`GET https://app.rubberstamp.io/api/v1/useralreadyregistered?email=...`
