...
field_query | Filter by concept, number, label or user_name | name of the field and the search term | `/book_entries?filter[field_query][field]=label[field_query][term]=tag_name`
