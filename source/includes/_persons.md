...
| current_organization_ids | integer[]   | An array of unique identifiers of companies that the person is associated with and are indicated as their current companies.                                                                                                                                                                         |
|  |
...
| with_current_organizations      | boolean | false    | When true, the IDs of person's current organizations will be returned.                                                                                                                                                                              |
