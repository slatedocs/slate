...
**kilogram_weight** <div class="optional"><a href="#weights-and-dimensions">more details</a></div> | Must be a decimal value over zero and less than the category/max weight allowed (25kg max).
**cubic_metre_volume** <div class="optional"><a href="#weights-and-dimensions">more details</a></div> | Must be a decimal value above zero and less than one.  To get value, multiply *length* x *width* x *depth* of parcel in metres.
