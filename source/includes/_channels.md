...
### <u>The channel object</u>

Field | Description
------:|:------------
__name__ <br><font color="DarkGray">_string_</font> <font color="Crimson">__(primary key)__</font> | A unique integer identifier for each channel.
...
method | `GET`
url_params | `name` <font color="DarkGray">_(string)_</font>
