...
código de convênio ou do cedente, de acordo com o banco. No caso do Itaú deve ser igual ao campo 'account' da conta bancária
agreement_code_digit: string
verificador do código de convênio, de acordo com o banco, no caso do Itaú deve ser igual ao campo 'account_digit' da conta bancária e no HSBC deve permanecer em branco
name: string
...
status: string
caso for 'pending' a conta ainda não está homologada
...
bank_account_id:  integer requirido
