...
| charge_template_id             | integer          | (opcional) número do modelo de cobrança a ser utilizado. A cobrança será criada com base nos atributos preestabelecidos do modelo, porém caso seja passado por parâmetro outro valor este terá preferência.                                                                                                                                                    |
