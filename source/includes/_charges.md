...
| email_reply_to            | string           | (opcional) Endereço de email a ser utilizado na respsta ao email de notificação de cobrança, caso a opção auto_send_billet estiver com valor 'true'                                                                                                                                                                                                            |
