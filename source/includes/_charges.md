...
| for_homologation               | boolean          | **(requerido, se a configuração de cobrança for não homologada )** indica se é uma cobrança para ser utilizada na homologação da Configuração de cobrança                             |
