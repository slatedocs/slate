...
| document_number                | string           | (opcional) número do documento é o número utilizado e controlado pelo beneficiário para identificar o título de cobrança. Este valor deve ser único para cobranças de mesmo valor total da cobrança, data de vencimento e configuração de cobrança. Caso não seja informado é atribído automaticamente o id da cobrança.          |
