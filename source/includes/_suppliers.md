...
RestClient.post(
  'https://app.rubberstamp.io/api/v1/suppliers',
  {
    supplier: {
      name: 'iCare Center',
...
```shell
curl 'https://app.rubberstamp.io/api/v1/suppliers'
  -X POST
...
`POST https://app.rubberstamp.io/api/v1/suppliers`
...
`GET https://app.rubberstamp.io/api/v1/suppliers`
...
RestClient.get(
  'https://app.rubberstamp.io/api/v1/suppliers/1',
  headers = {
    authentication_token: 'your token',
    app_company_id: 1
  }
...
```shell
curl 'https://app.rubberstamp.io/api/v1/suppliers/1'
  -X GET
  -H "Content-Type: application/json"
  -H "authentication_token: your token"
  -H "app_company_id: 1"
...
`PUT https://app.rubberstamp.io/api/v1/suppliers/:id`
