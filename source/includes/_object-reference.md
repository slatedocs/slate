...
Multiple Response and Categorical Array variables contain an array of subvariable
 IDs. In the HTTP API, these are presented as URLs. To bind existing variables
 into an array of type "multiple_response" or "categorical_array", you must include a 
 "subvariables" member with an array of IDs. These identify the subvariables
