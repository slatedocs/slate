...
<a name="overview"></a>
## Overview
Onboard and maintain investors.
...
* ISA : Calls related to ISAs.
* accounts : Calls related an investor's account(s).
* investor : Calls related to investors
* registration : Calls related to registration
...
|---|---|---|---|
|**Body**|**investor**  <br>*optional*|Investor to add|[CreateInvestor](#createinvestor)|
...
|---|---|---|
|**200**|The investor.|[Investor](#investor)|
...
|**investmentDeclarationType**  <br>*optional*|The investor type declared by the investor|enum (RESTRICTED, HIGH_NET_WORTH, INVESTMENT_PROFESSIONAL, SOPHISTICATED)|
...
|Name|Description|Schema|
|---|---|---|
|**status**  <br>*optional*|The KYB status of a corporate investor|enum (DOCUMENTS_REQUIRED, VERIFIED)|
...
|Name|Description|Schema|
|---|---|---|
|**accountNumber**  <br>*optional*|The account number to transfer the funds to.|string|
|**address**  <br>*optional*||[Address](#address)|
|**bankReference**  <br>*optional*|The reference to use for the bank transfer.|string|
|**name**  <br>*optional*|The name of the ISA manager.|string|
|**sortCode**  <br>*optional*|The sort code to transfer the funds to.|string|


<a name="listtransfersout"></a>
### List Transfers Out
*Type* : < [transferOut](#transferout) > array
...
|Name|Description|Schema|
|---|---|---|
|**amount**  <br>*required*|The amount  <br>**Example** : `123.45`|number|
|**currency**  <br>*required*|The currency in ISO 4217 three character codes eg 'GBP'|string|


<a name="transferinbreakdown"></a>
### Transfer In Deposit Summary
A summary of a transfer in cheque processing.


|Name|Description|Schema|
|---|---|---|
|**clientId**  <br>*optional*|The ID of the investor for the transfer in|string|
|**id**  <br>*optional*|The transfer in ID|string|


<a name="transferindeposits"></a>
### Transfer In Deposit Summary
A summary of a transfer in cheque processing.
...
|Name|Description|Schema|
|---|---|---|
|**numberCheques**  <br>*optional*|The number of cheques included in the summary|number|
|**products**  <br>*optional*||< [transferInBreakdown](#transferinbreakdown) > array|
|**totalValue**  <br>*optional*|The total value of cheque transfers in|[monetaryAmount](#monetaryamount)|


<a name="transferinsummaries"></a>
### Transfer In Summaries
Transfer in summaries

*Type* : < [transferInSummary](#transferinsummary) > array


<a name="transferinsummary"></a>
### Transfer In Summary
A summary of a transfer in


|Name|Description|Schema|
|---|---|---|
|**bankReference**  <br>*optional*|The bank reference|string|
|**clientId**  <br>*optional*|The ID of client|string|
|**fundsTransferType**  <br>*optional*|The funds transfer type|string|
|**id**  <br>*optional*|The ID of the transfer in|string|
|**repairAmount**  <br>*optional*|The repair amount|[monetaryAmount](#monetaryamount)|
|**totalTransferAmount**  <br>*optional*|The total amount being transferred|[monetaryAmount](#monetaryamount)|
|**transferInDate**  <br>*optional*|The date stated on the transfer history form|string (date)|


<a name="transferout"></a>
### Transfer Out

|Name|Description|Schema|
|---|---|---|
|**amountToTransfer**  <br>*optional*||[monetaryAmount](#monetaryamount)|
|**amountToTransferAlert**  <br>*optional*|True if the amount requested to be transferred cannot be satisfied. If this is true, the transfer cannot be processed until it is resolved.|boolean|
|**dateFundsTransferred**  <br>*optional*|The date the funds were transferred to the new ISA manager.|string (date)|
|**id**  <br>*optional*|The ID Goji assigns to the Transfer Out request.|string|
|**isaManager**  <br>*optional*||[isaManager](#isamanager)|
|**transferDetails**  <br>*optional*||[transferOutDetails](#transferoutdetails)|


<a name="transferoutdetails"></a>
### Transfer Out Details

|Name|Description|Schema|
|---|---|---|
|**dateTAFReceived**  <br>*optional*|The date the transfer authority form was received from the ISA manager.|string (date)|
|**priorYearAmountToTransfer**  <br>*optional*|The amount of prior year subscriptions to transfer if only part of the prior year balance should be transferred.|[monetaryAmount](#monetaryamount)|
|**transferAll**  <br>*optional*|True if all ISA subscriptions should be transferred.|boolean|
|**transferAllPriorYearSubscriptions**  <br>*optional*|True if all prior year subscriptions should be transferred.|boolean|
|**transferCurrentYearSubscriptions**  <br>*optional*|True if current year subscriptions should be transferred.|boolean|
|**transferDateFromNewIsaManager**  <br>*optional*|The date the ISA manager has said they will accept subscriptions from.|string (date)|
|**transferPriorYearSubscriptions**  <br>*optional*|True if prior year subscriptions should be transferred.|boolean|
