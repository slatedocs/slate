...
| ----------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| title                               | string | The title of the investor.                                                                                                                                                                         | optional |
...
| investorDeclarationType             | string | All investors must complete a declaration to confirm the kind of investor they are.                                                                                                                | required |
