...
This method lets you add a card token to a customer. Full card numbers are only accepted through the [Plugin](https://docs.slycepay.com/plugin/#add-card).
...
reference* |  | Card Reference token. Accepts only tokens generated by the [Plugin](https://docs.slycepay.com/plugin/#add-card).
