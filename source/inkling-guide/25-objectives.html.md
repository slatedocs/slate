...
[Source](http://docs.bons.ai/inkling-guide-pages/25-objectives "Permalink to (2.6) Objectives - Bons.ai")

# (2.6) Objectives - Bons.ai
...
_   **with** _trainingSpecifier
_  **objective** _objectiveName
_  #lessons are specified here for more information, see [lesson][1].
end
