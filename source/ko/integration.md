...
_PD_START_
: 기간제 타입에서 사용해야 하는 기간 중 시작 날짜와 시간입니다. 기간제 타입을 선택하시면 반드시 이 parameter에 해당하는 값을 넣어 주셔야 합니다. 날짜와 시간은 GMT 시간으로 설정

_PD_END_
: 기간제 타입에서 사용해야 하는 기간 중 종료 날짜와 시간입니다. 기간제 타입을 선택하시면 반드시 이 parameter에 해당하는 값을 넣어 주셔야 합니다. 날짜와 시간은 GMT 시간으로 설정 
