...
`orderId` |  Integer | binance*, bitfinex, bitstamp 
...
<aside class="note"> NOTE: Binance orderIds are not generated by Binance.  We receive batches of orders from Binance with a first and last Id. We use these to assign orderIds. </aside>   
