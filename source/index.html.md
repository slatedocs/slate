...
```
Code will be shown here in sila-test panel.
```
...
<aside class="notice">
<b>Note</b>: this does not take any per-transaction fees into account. <b>No fees are currently applied on transactions in this beta version of the API.</b>
</aside>
