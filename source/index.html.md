...
## Definitions
Report - set of insights on a particular topic (e.g. Intelligence report on protein powers).

Topic - the subject for which Factmata generates insights for a customer, e.g. an industry (e.g. Protein powders), a brand (e.g. Avon), a product (J&J Baby Shampoo) or event (e.g. Coronavirus outbreak). The topic is defined by the customer.

Theme - a prominent aspect of a topic based on opinions that are the most interesting or popular (e.g. themes for the protein powders topic would be: price, flavour, ingredients, etc). The themes are extracted automatically.
...
## Metrics description
Name | Definition | Type | Range  
-----| ---- | ----- | ----- |-
negative_stance_score | Likelihood of a piece of text being unfavourable towards the topic | float | 0.00 - 1.00
positive_stance_score | Likelihood of a piece of text being favourable towards the topic | float | 0.00 - 1.00
outlierness_score | Content which are less frequently featured on the Internet or seem unusual | float | 0.00 - 1.00
popularity_score | Number of shares and likes a piece of text has received |  integer | 0+
influencer_score | Number of followers of an opinion maker | integer | 0+
propaganda_score | | float | 0.00 - 1.00
bot_generated_score | Likelihood of a piece of text to have been generated by bots | float | 0.00 - 1.00
...
Name | Social media | Any other (e.g. reviews, news, customer care transcripts)
-----| --------------------------- | -------------------------------- | -
negative_stance_score | yes | yes
positive_stance_score | yes | yes
