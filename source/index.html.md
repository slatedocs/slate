...
* 3D visualisations, 
* algorithms, 
* decision support (dashboards) and 
* automated decision-making (Netflix product recommendations or Spotify’s Discover Weekly would be common examples). 
