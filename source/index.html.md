...
outlierness_score | Interesting content which is less frequently featured on the Internet or seem unusual | float | 0.00 - 1.00
popularity_score | Number of shares and likes a piece of text has received |  integer | 0+
influencer_score | Number of Twitter followers an opinion maker has | integer | 0+
propaganda_score | Likelihood that a piece of text is politically biased| float | 0.00 - 1.00
bot_generated_score | Likelihood that a piece of text have been generated by bots | float | 0.00 - 1.00
threat_score |Likelihood of biased views being widely spread. The metric takes into account propaganda score and popularity. | float | 0.00 - 1.00
